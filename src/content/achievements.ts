...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { id: 'first-rack', name: 'Full Litter', desc: 'Own 25 of one source.', check: (s) => maxOwned(s) >= 25 },
  ...
  { id: 'first-light', name: 'Second Life', desc: 'Ascend for the first time.', check: (s) => s.stats.ascensions >= 1 },
